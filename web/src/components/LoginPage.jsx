        ...
        <div className="fixed inset-0 w-full h-full bg-[#f5f5f7] flex items-center justify-center p-4">
            ...
            >
                <div className="text-center mb-8">
                    <h1 className="text-3xl font-bold text-neutral-900 tracking-tight">Photomato</h1>
                    <p className="text-sm text-neutral-500 mt-2">Private Gallery</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="space-y-2">
                        ...
                        {error && <p className="text-xs text-red-500 text-center font-medium">Incorrect password</p>}
                    </div>
