            ...
            <section className="mb-12">
                ...
                <div className="bg-neutral-50/50 rounded-xl border border-neutral-100 overflow-hidden">
                    <div className="p-4 flex items-center justify-between border-b border-neutral-100 last:border-0">
                        ...
                        <div className="flex items-center gap-2">
                            <a
                                ...
                                className="flex items-center gap-1.5 px-3 py-1.5 bg-neutral-900 text-white hover:bg-neutral-800 rounded-lg text-xs font-medium transition-colors"
                            >
                    ...
                    <div className="p-4 border-b border-neutral-100 last:border-0">
                        <div className="font-medium text-neutral-900 text-sm">开源协议</div>
                        <div className="text-[11px] text-neutral-400 mt-0.5">本项目遵循 MIT 协议开源</div>
                    </div>
                </div>
            </section>
        </div>
