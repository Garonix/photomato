...
export function AlbumCapsule({ aliases = [], activeAlias, onAliasChange }) {
    ...
    // Handle wheel scroll on capsule
    ...
    return (
        <div ref={capsuleRef} className="relative">
            ...
            <button
                ...
                onWheel={handleWheel}
                className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-neutral-100 hover:bg-neutral-200/80 transition-colors text-sm font-medium text-neutral-700 max-w-[200px] group"
            >
